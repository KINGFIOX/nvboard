#ifndef NVBOARD_PINS_H_
#define NVBOARD_PINS_H_

// RST is defined but not used. NVBoard contains some internal states in *.cc
// files. Only resetting the RTL design in *.v file may make the RTL design and
...
#define NAIVE_LEDS_OUTPUT                                                      \
  LD0, LD1, LD2, LD3, LD4, LD5, LD6, LD7, LD8, LD9, LD10, LD11, LD12, LD13,  \
      LD14, LD15

#define RGB_LEDS_OUTPUT R16, G16, B16, R17, G17, B17

#define SEG7_SEGS_OUTPUT                                                       \
  SEG0A, SEG0B, SEG0C, SEG0D, SEG0E, SEG0F, SEG0G, DEC0P, SEG1A, SEG1B,      \
      SEG1C, SEG1D, SEG1E, SEG1F, SEG1G, DEC1P, SEG2A, SEG2B, SEG2C, SEG2D,  \
      SEG2E, SEG2F, SEG2G, DEC2P, SEG3A, SEG3B, SEG3C, SEG3D, SEG3E, SEG3F,  \
      SEG3G, DEC3P, SEG4A, SEG4B, SEG4C, SEG4D, SEG4E, SEG4F, SEG4G, DEC4P,  \
      SEG5A, SEG5B, SEG5C, SEG5D, SEG5E, SEG5F, SEG5G, DEC5P, SEG6A, SEG6B,  \
...
#define VGA_OUTPUT                                                             \
  VGA_VSYNC, VGA_HSYNC, VGA_BLANK_N, VGA_R0, VGA_R1, VGA_R2, VGA_R3,         \
      ...
      VGA_G4, VGA_G5, VGA_G6, VGA_G7, VGA_B0, VGA_B1, VGA_B2, VGA_B3,        \
      VGA_B4, VGA_B5, VGA_B6, VGA_B7
